...
export class SpaceHypnaFeatureSpiralsWebgl extends FeatureBase {
  ...
  override preload(): void {
    ...
    this.gl.uniform3fv(bgColorUniformLocation, this.workspace.bg_color ? [this.workspace.bg_color.red / 255, this.workspace.bg_color.green / 255, this.workspace.bg_color.blue / 255] : [0,0,0]); // Black
    ...
    if(this._service.vr){
      ...
      this.gl2.uniform3fv(spiralColorUniformLocation, this.workspace.spiral_color ? [this.workspace.spiral_color.red / 255, this.workspace.spiral_color.green / 255, this.workspace.spiral_color.blue / 255] : [1,0,0]); // Red
      this.gl2.uniform3fv(bgColorUniformLocation, this.workspace.bg_color ? [this.workspace.bg_color.red / 255, this.workspace.bg_color.green / 255, this.workspace.bg_color.blue / 255] : [0,0,0]); // Black
